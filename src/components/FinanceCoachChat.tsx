...
const FinanceCoachChat = () => {
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      role: 'assistant',
      content: "Hey! I'm your personal finance coach. Ask me anything about your spending, goals, or how to improve your credit score. 💪",
      timestamp: new Date()
    }
  ]);
...
- Monthly allowance/income: $${userContext.monthlyAllowance}
- Total spent this month: $${userContext.totalSpent}
- Savings goal: $${userContext.savingsGoal}
- Actual savings: $${userContext.actualSavings}
- Current credit score: ${userContext.currentScore}
- Number of transactions logged: ${userContext.transactionCount}
- Category spending: ${Object.entries(userContext.categoryBreakdown).map(([cat, amount]) => `${cat}: $${amount}`).join(', ')}
...
export default FinanceCoachChat;
